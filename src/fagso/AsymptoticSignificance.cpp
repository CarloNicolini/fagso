...
double asymptoticSignificance(long clustersize, double clusterdensity, double graphdensity)
{
    return clustersize*(clustersize-1)/2*KL(clusterdensity,graphdensity);
}
