...
double asymptoticModularity(double intraClusterEdges, double totalEdges, double intraclusterDegree)
{
    return KL(intraClusterEdges/totalEdges, pow(intraclusterDegree/(2*totalEdges),2.0));
}
