...
#ifndef _ASYMPTOTIC_SIGNIFICANCE_H_
#define _ASYMPTOTIC_SIGNIFICANCE_H_

#include "KLDivergence.h"

double asymptoticSignificance(long int clustersize, double clusterdensity, double graphdensity);
#endif
